...
<html>
    <head>
        ...
        <title>Hobby Union - Movie Reviews</title>
    </head>
    <body>
        <header>
        ...
        <main>
            ...
            <div class='container md-col-6'><p><font size="6" face="Georgia, Arial" color="maroon">Movie Reviews</font></p>
            <?php
            ...
            require_once('/protected/config.php');
            $sql="SELECT * FROM article a ,user u WHERE a.UserID=u.UserID AND Interest='Movies' ORDER BY DatePosted DESC LIMIT 5;";
