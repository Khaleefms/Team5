...
<html>
    <head>
        ...
        <title>Hobby Union - Anything Under The Sun</title>
    </head>
    <body>
        <header>
        ...
        <main>
            ...
            <div class='container md-col-6'><p><font size="6" face="Georgia, Arial" color="maroon">Anything Under The Sun</font></p>
            <?php
    ...
    require_once('/protected/config.php');
    $sql="SELECT * FROM article a ,user u WHERE a.UserID=u.UserID AND Interest='Others' ORDER BY DatePosted DESC LIMIT 5;";
