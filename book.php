...
<html>
    ...
    <body>
        ...
        <main>
            ...
            <div class='container md-col-6'><p><font size="6" face="Georgia, Arial" color="maroon">Book Reviews</font></p>
            <?php
    ...
    require_once('/protected/config.php');
    $sql="SELECT * FROM article a ,user u WHERE a.UserID=u.UserID AND Interest='Books' ORDER BY DatePosted DESC LIMIT 5;";
