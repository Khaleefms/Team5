<?php
    ...
    require_once('/protected/config.php');
    $sql="SELECT * FROM article a ,user u WHERE a.UserID=u.UserID ORDER BY DatePosted DESC LIMIT 5;";
    $result = mysqli_query($connection, $sql);
                ...
                ?>
                 <div class="container1">
                    ...
                    <div id="button">
                        <button type="button" class="btn btn-info center-block" data-toggle="collapse" data-target="#new<?php echo $ArticleID?>">View whole article</button>
                    </div>
                    <br>
                    <div id="new<?php echo $ArticleID?>" class="collapse out">
